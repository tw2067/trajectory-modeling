...
def main():
    ...
    parser.add_argument('--input', type=str,
                       default=os.path.join(_DATA_ROOT, 'eicu', 'liver', 'bilirubin_timeseries.csv'),
                       help='Path to raw bilirubin time series CSV')
    parser.add_argument('--pred-dataset', type=str,
                       default=os.path.join(_DATA_ROOT, 'eicu', 'liver', 'liver_prediction_dataset.csv'),
                       help='Path to prediction dataset for merging')
    parser.add_argument('--output', type=str,
                       default=os.path.join(_DATA_ROOT, 'eicu', 'liver', 'liver_trajectory_probs.csv'),
                       help='Path to save prediction dataset merged with probabilities')
    parser.add_argument('--probs-output', type=str,
                       default=os.path.join(_DATA_ROOT, 'eicu', 'liver', 'liver_trajectory_probs_bayes.csv'),
