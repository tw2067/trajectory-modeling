...
def main():
    ...
    parser.add_argument('--data-dir', type=str, default=os.path.join(_DATA_ROOT, 'mimic', 'circulatory_failure'),
                        help='Directory containing biomarker time series CSVs')
    parser.add_argument('--pred-dataset', type=str, default=os.path.join(_DATA_ROOT, 'mimic', 'circulatory_failure', 'circulatory_failure_prediction_dataset.csv'),
