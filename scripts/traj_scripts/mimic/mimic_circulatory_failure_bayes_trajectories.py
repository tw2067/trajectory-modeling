#!/usr/bin/env python3
"""MIMIC Circulatory Failure Bayesian trajectory generation (full dataset with nutpie)."""
...
DATA_ROOT = os.path.join(os.environ.get("TRAJ_DATA_ROOT", "/home/gaga/data/physionet"), "mimic", "circulatory_failure")


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="MIMIC Circulatory Failure Bayesian Trajectory Generation (full dataset)")
...
def main() -> None:
    ...
    traj_script = root / "scripts" / "trajectory" / "mimic" / "circulatory_failure_trajs.py"
