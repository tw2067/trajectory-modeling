...
def main():
    ...
    parser.add_argument('--input', type=str,
                        default='/home/gaga/data/physionet/mimic/sepsis/lactate_timeseries.csv',
                        help='Path to raw biomarker time series CSV (single-biomarker mode)')
    parser.add_argument('--data-dir', type=str,
                        default='/home/gaga/data/physionet/mimic/sepsis',
                        help='Directory containing biomarker time series CSVs (all-biomarker mode)')
    parser.add_argument('--pred-dataset', type=str,
                        default='/home/gaga/data/physionet/mimic/sepsis/sepsis_prediction_dataset.csv',
    ...
    bm = args.biomarker
    output_path = Path(args.output) if args.output else Path(f"/home/gaga/data/physionet/mimic/sepsis/{bm}_trajectory_probs_bayes.csv")
