...
OUTPUT_PATH = os.path.join(_TRAJ_DATA_ROOT, "eicu", "liver", "liver_prediction_dataset.csv")
...
bilirubin_ts_output = os.path.join(_TRAJ_DATA_ROOT, "eicu", "liver", "bilirubin_timeseries.csv")
